...
public class QueryTestbed {
    ...
    //URLs
    public final String GET_ALL_RESOURCES_URL = "http://smart-ics1.ee.surrey.ac.uk/fiesta-iot/registry/getAllResources";
    public final String GET_RESOURCE_URL1 = "http://smart-ics1.ee.surrey.ac.uk/fiesta-iot/resource/sc-sics-sp-001-power";
    public final String GET_RESOURCE_URL2 = "http://smart-ics1.ee.surrey.ac.uk/fiesta-iot/resource/sc-sics-sp-002-power";
    public final String GET_OBSERVATIONS_URL = "http://smart-ics1.ee.surrey.ac.uk/fiesta-iot/tps/getObservations";
    public final String GET_OBSERVATION_URL1 = "http://smart-ics1.ee.surrey.ac.uk/fiesta-iot/service/sc-sics-sp-001-power";

    //Requests
    public final String GET_OBSERVATIONS_REQUEST1 = "/request/getObs.json";

    //Ontology files
    protected final String BASE_ONTOLOGY = "/ontologies/fiesta_iot/fiesta-iot.owl";

    //SPARQL Queries
    protected final String SPARQL_QUERY1 = "/query/sensors_declared.rq";
    protected final String SPARQL_QUERY2 = "/query/sensing_device_list.rq";
    protected final String SPARQL_DESCRIBE_SENSORS = "/query/describe_sensors.rq";
    protected final String SPARQL_GET_SUBCLASSES = "/query/get_subclasses.rq";
    protected final String SPARQL_GET_OBSERVATIONS = "/query/get_observations.rq";
    protected final String SPARQL_GET_RES_OBS = "/query/discover_and_get_obs.rq";
